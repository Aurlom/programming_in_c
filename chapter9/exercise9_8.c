// Chapter 9, Exercise 8 (p. 231)

// use findString(), removeString(), and insertString() to write a replaceString() function
// replaceString (source, s1, s2). Source is the original string, s1 should be replaced by s2
...
int main (void)
{
    ...
    replaceString (text1, "had", "have eaten");
    replaceString (text1, "apples.", "bananas!");
